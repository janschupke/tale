...
import io.schupke.tale.content.stage.level.settlement.obstacle.OutskirtsTransitionWall;
import io.schupke.tale.content.stage.level.settlement.obstacle.blacksmith.BlacksmithObstacle;
import io.schupke.tale.content.stage.level.settlement.obstacle.chobo_house.ChoboHouseObstacle;
import io.schupke.tale.content.stage.level.settlement.obstacle.dungeon.DungeonObstacle;
import io.schupke.tale.content.stage.level.settlement.obstacle.farm.FarmObstacle;
import io.schupke.tale.content.stage.level.settlement.obstacle.fountain.FountainObstacle;
import io.schupke.tale.content.stage.level.settlement.obstacle.road_sign.RoadSignObstacle;
import io.schupke.tale.content.stage.level.settlement.obstacle.tavern.TavernObstacle;
import io.schupke.tale.content.stage.level.settlement.sensor.ChoboExplorationSensor;
import io.schupke.tale.content.stage.level.settlement.sensor.DungeonExplorationSensor;
import io.schupke.tale.content.stage.level.settlement.sensor.OutskirtsTransitionSensor;
import io.schupke.tale.content.stage.level.settlement.unit.chobo.ChoboUnit;
import io.schupke.tale.content.stage.level.settlement.unit.smith.SmithUnit;
