...
import io.schupke.tale.content.stage.level.outskirts.item.lumber.LumberItem;
import io.schupke.tale.content.stage.level.outskirts.item.varpunen.VarpunenItem;
import io.schupke.tale.content.stage.level.outskirts.obstacle.ForestTransitionWall;
import io.schupke.tale.content.stage.level.outskirts.obstacle.SettlementTransitionWall;
import io.schupke.tale.content.stage.level.outskirts.obstacle.cave.CaveObstacle;
import io.schupke.tale.content.stage.level.outskirts.obstacle.crone_shack.CroneShackObstacle;
import io.schupke.tale.content.stage.level.outskirts.obstacle.jack_house.JackHouseObstacle;
import io.schupke.tale.content.stage.level.outskirts.obstacle.road_sign.RoadSignObstacle;
import io.schupke.tale.content.stage.level.outskirts.sensor.CaveExplorationSensor;
import io.schupke.tale.content.stage.level.outskirts.sensor.ForestTransitionSensor;
import io.schupke.tale.content.stage.level.outskirts.sensor.JackExplorationSensor;
import io.schupke.tale.content.stage.level.outskirts.sensor.SettlementTransitionSensor;
import io.schupke.tale.content.stage.level.outskirts.sensor.VarpunenExplorationSensor;
import io.schupke.tale.content.stage.level.outskirts.unit.crone.CroneUnit;
import io.schupke.tale.content.stage.level.outskirts.unit.jack.JackUnit;
