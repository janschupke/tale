package io.schupke.tale.content.stage.level.dungeon.event;

import io.schupke.tale.base.App;
import io.schupke.tale.base.event.handling.LevelEventHandler;
import io.schupke.tale.content.stage.level.dungeon.event.exploration.StudyExplorationEvent;
import io.schupke.tale.content.stage.level.dungeon.event.general.ExitWarningEvent;
import io.schupke.tale.content.stage.level.dungeon.event.interaction.chest.ChestCollectInteractionEvent;
import io.schupke.tale.content.stage.level.dungeon.event.interaction.chest.ChestInteractionEvent;
import io.schupke.tale.content.stage.level.dungeon.event.interaction.chest.ChestSearchInteractionEvent;
import io.schupke.tale.content.stage.level.dungeon.event.interaction.gate.GateInteractionEvent;
import io.schupke.tale.content.stage.level.dungeon.event.interaction.gate.GateOpenInteractionEvent;
import io.schupke.tale.content.stage.level.dungeon.event.interaction.harpsichord.HarpsichordInteractionEvent;
import io.schupke.tale.content.stage.level.dungeon.event.interaction.harpsichord.HarpsichordPlayInteractionEvent;
import io.schupke.tale.content.stage.level.dungeon.event.transition.ExitTransitionEvent;
import io.schupke.tale.content.stage.level.dungeon.event.transition.SettlementTransitionEvent;
