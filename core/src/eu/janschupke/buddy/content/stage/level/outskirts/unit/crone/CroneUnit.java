package eu.janschupke.buddy.content.stage.level.outskirts.unit.crone;

import com.badlogic.gdx.Gdx;
import com.badlogic.gdx.graphics.Texture;
import com.badlogic.gdx.graphics.g2d.TextureRegion;
import eu.janschupke.buddy.content.stage.level.outskirts.OutskirtsEventHandler;
import eu.janschupke.buddy.content.stage.level.outskirts.unit.crone.interaction.CroneInteraction;
...
public class CroneUnit extends Unit implements Triggerable {
    ...
    public void disengage() {
        try {
            ...
            Gdx.app.log("CroneUnit#disengage", "No HUD problem");
        }
    }
