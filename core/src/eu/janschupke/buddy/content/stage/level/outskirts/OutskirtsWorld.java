...
import eu.janschupke.buddy.content.stage.level.outskirts.item.lumber.LumberItem;
import eu.janschupke.buddy.content.stage.level.outskirts.item.varpunen.VarpunenNoteItem;
import eu.janschupke.buddy.content.stage.level.outskirts.obstacle.cave.CaveObstacle;
import eu.janschupke.buddy.content.stage.level.outskirts.obstacle.crone_shack.CroneShackObstacle;
import eu.janschupke.buddy.content.stage.level.outskirts.obstacle.jack_house.JackHouseObstacle;
import eu.janschupke.buddy.content.stage.level.outskirts.obstacle.road_sign.RoadSignObstacle;
import eu.janschupke.buddy.content.stage.level.outskirts.sensor.*;
import eu.janschupke.buddy.content.stage.level.outskirts.unit.crone.CroneUnit;
import eu.janschupke.buddy.content.stage.level.outskirts.unit.jack.JackUnit;
