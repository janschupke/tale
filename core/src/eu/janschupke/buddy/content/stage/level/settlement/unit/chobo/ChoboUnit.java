package eu.janschupke.buddy.content.stage.level.settlement.unit.chobo;

import com.badlogic.gdx.Gdx;
import com.badlogic.gdx.graphics.Texture;
import com.badlogic.gdx.graphics.g2d.TextureRegion;
import eu.janschupke.buddy.content.stage.level.settlement.SettlementEventHandler;
import eu.janschupke.buddy.content.stage.level.settlement.unit.chobo.interaction.ChoboInteraction;
...
public class ChoboUnit extends Unit implements Triggerable {
    ...
    public ChoboUnit(BaseWorld world) {
        super(world, new Texture(Gdx.files.internal("textures/levels/settlement/units/chobo.png")));
        animationTexture = new Texture(Gdx.files.internal("textures/levels/settlement/units/chobo.png"));
