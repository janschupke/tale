package eu.janschupke.buddy.content.stage.level.cave.obstacle.spring;

import com.badlogic.gdx.Gdx;
import com.badlogic.gdx.graphics.Texture;
import com.badlogic.gdx.math.Vector2;
import eu.janschupke.buddy.content.stage.level.cave.CaveEventHandler;
import eu.janschupke.buddy.content.stage.level.cave.obstacle.spring.interaction.SpringInteraction;
...
public class SpringObstacle extends Obstacle implements Triggerable {
    ...
    public void disengage() {
        try {
            ...
            Gdx.app.log("SpringObstacle#disengage", "No HUD problem");
        }
    }
