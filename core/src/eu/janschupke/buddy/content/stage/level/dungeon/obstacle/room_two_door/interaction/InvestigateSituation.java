...
public class InvestigateSituation extends Situation {
    public InvestigateSituation(final App app) {
        super(app, app.getLang().get("level.dungeon.interaction.door-two.investigate.description"));
    ...
    class LeaveDecision extends Decision {
        public LeaveDecision() {
            super(app.getLang().get("level.dungeon.interaction.door-two.investigate.decision.leave"),
                    DecisionTags.DUNGEON_ROOM_TWO_DOOR_LEAVE);
        }
