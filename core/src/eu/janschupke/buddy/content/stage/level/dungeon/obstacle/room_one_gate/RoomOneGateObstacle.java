package eu.janschupke.buddy.content.stage.level.dungeon.obstacle.room_one_gate;

import com.badlogic.gdx.Gdx;
import com.badlogic.gdx.graphics.Texture;
import com.badlogic.gdx.math.Vector2;
import eu.janschupke.buddy.content.stage.level.dungeon.DungeonEventHandler;
import eu.janschupke.buddy.content.stage.level.dungeon.obstacle.room_one_gate.interaction.RoomOneGateInteraction;
...
public class RoomOneGateObstacle extends Obstacle implements Triggerable {
    ...
    public void disengage() {
        try {
            ...
            Gdx.app.log("RoomOneGateObstacle#disengage", "No HUD problem");
        }
    }
